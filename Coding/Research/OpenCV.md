...
- **Autonomous Driving**: Utilises lane detection, pedestrian recognition, and obstacle avoidance.
- **Healthcare**: Improves MRI and X-ray scans and aids tumour detection.
- **Security**: Employs facial recognition systems and real-time surveillance for intruder detection.
- **Retail**: Powers checkout-free shopping and augmented reality try-on tools.
